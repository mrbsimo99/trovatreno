    ...
    <div className="min-h-screen bg-gray-100 py-8 md:py-16">
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          ...
          {/* <p className="mt-4 flex justify-center font-bold text-red-300 hover:text-red-500 cursor-pointer">Cerca Treni dalla Stazione</p>  */}

          {loading && (
            <div className="text-center mt-6">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-red-600"></div>
              <p className="text-gray-600 mt-2 text-sm">Ricerca in corso...</p>
            </div>
          )}
          {error && (
            <p className="text-center text-red-600 mt-6 bg-red-50 p-3 rounded-lg border border-red-200">
              {error}
            </p>
          )}
        </div>
        ...
        {trainData && trainData.data.stazioneUltimoRilevamento !== "--" && (
          <div className="max-w-2xl mx-auto mt-4 p-4 bg-white rounded-lg shadow-md border border-gray-200 flex items-center justify-between">
            ...
            <button
              ...
              className="p-2 md:p-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex-shrink-0 ml-2"
              title="Aggiorna"
            >
              <RefreshCw size={20} />
            </button>
